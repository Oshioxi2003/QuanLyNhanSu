namespace GUI.UC
{
    partial class uc_contract
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gcContract.Location = new System.Drawing.Point(0, 40);
            this.gcContract.MainView = this.gvContract;
            this.gcContract.MenuManager = this.barManager1;
            this.gcContract.Name = "gcContract";
            this.gcContract.Size = new System.Drawing.Size(952, 454);
            this.gcContract.TabIndex = 25;
            this.gcContract.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvContract});
            this.gcContract.ProcessGridKey += new System.Windows.Forms.KeyEventHandler(this.gcContract_ProcessGridKey);
            // 
            // gvContract
            // 
            ...
            this.gridColumn2,
            this.gridColumn3});
            this.gvContract.DetailHeight = 368;
            this.gvContract.GridControl = this.gcContract;
            this.gvContract.Name = "gvContract";
            this.gvContract.OptionsDetail.EnableMasterViewMode = false;
            this.gvContract.OptionsFind.AlwaysVisible = true;
            this.gvContract.OptionsFind.Condition = DevExpress.Data.Filtering.FilterCondition.Contains;
            this.gvContract.OptionsFind.FindDelay = 100;
            this.gvContract.OptionsFind.FindNullPrompt = "Tìm kiếm tại đây...";
            this.gvContract.OptionsFind.ShowFindButton = false;
            this.gvContract.OptionsView.ShowGroupPanel = false;
            this.gvContract.CustomDrawRowIndicator += new DevExpress.XtraGrid.Views.Grid.RowIndicatorCustomDrawEventHandler(this.gvContract_CustomDrawRowIndicator);
            this.gvContract.InvalidRowException += new DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventHandler(this.gvContract_InvalidRowException);
            this.gvContract.ValidateRow += new DevExpress.XtraGrid.Views.Base.ValidateRowEventHandler(this.gvContract_ValidateRow);
            // 
            // gridColumn1
            // 
            this.gridColumn1.Caption = "Tên hợp đồng";
            ...
            this.gridColumn3.FieldName = "allowance";
